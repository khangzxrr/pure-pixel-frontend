...
type StatusFilter = Schema<"BookingStatus"> | "";
// the list also returns timestamps, which BookingDto does not declare
type CustomerBookingItem = Schema<"BookingDto"> & { updatedAt?: string };
...
export default function CustomerBooking() {
  ...
  const [orderByCreatedAt, setOrderByCreatedAt] = useState<SortOrder>("desc");
  const [selectedBooking, setSelectedBooking] = useState("");
  const popupReport = useModalState();

  const isSelectedStatus = (value: StatusFilter) => {
    return status === value;
  };
  ...
  const reportBooking = (bookingId: string) => {
      ...
      {isPending ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
          {data &&
            ...
            data.objects.map((booking: CustomerBookingItem) => (
              <div
              ...
              >
                ...
                <div className="flex flex-col gap-1 px-4 py-2 hover:cursor-pointer">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <ChatButton
                      userId={String(booking.originalPhotoshootPackage?.user.id)}
                    />
