...
type MyPhotoshootPackageDetailInfoProps = {
  photoshootPackage: PhotographerPhotoshootPackage;
  setIsUpdatePhotoshootPackageModal: (value: boolean) => void;
  setSelectedUpdatePhotoshootPackage: (packageId: string) => void;
};
...
}: MyPhotoshootPackageDetailInfoProps) => {
