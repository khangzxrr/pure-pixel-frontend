...
// the photographer endpoints also return createdAt and booking counts, which PhotoshootPackageDto does not declare
export type PhotographerPhotoshootPackage = Schema<"PhotoshootPackageDto"> & {
  createdAt?: string;
  _count?: { bookings?: number };
};

type MyPhotoshootPackageCardProps = {
