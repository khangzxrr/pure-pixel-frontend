...
type CreateUpgradeProps = {
  onClose: () => void;
  tableRef: RefObject<TableUpgradeHandle>;
};
    ...
    if (change !== null) {
      postData("/manager/upgrade-package", {
        ...
        .catch((error: unknown) => {
          console.log(error);
          setDisabled(false);
          // postData rejects with the server response
        ...
        <FormProvider {...methods}>
          <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-xl">
            <div className="overflow-y-auto p-4">
              ...
              {errors.descriptions &&
                !fields.some((field) => get(field, "value") !== "") && (
                  <p>{errors.descriptions.message?.toString()}</p>
                )}
              <div className="sm:col-span-2">
                <button
                  type="button"
