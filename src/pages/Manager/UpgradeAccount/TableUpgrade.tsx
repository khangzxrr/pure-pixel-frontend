...
// the screens read `descriptions`, which UpgradePackageDto declares as `description`
export type UpgradeRow = Schema<"UpgradePackageDto"> & {
  descriptions: string[];
};

type UpgradeList = ResponseOf<"UpgradePackageController_findAll"> & {
  objects: UpgradeRow[];
};

export type TableUpgradeHandle = {
  reloadData: () => void;
};
...
export const TableUpgrade = forwardRef<TableUpgradeHandle, object>(
  (_props, ref) => {
    const [data, setData] = useState<UpgradeRow[]>([]);
    const [selectedData, setSelectedData] = useState<Partial<UpgradeRow>>({});
    ...
    const { getColumnSearchProps, getColumnPriceRangeProps } =
      useColumnFilters();
    const columns: TableProps<UpgradeRow>["columns"] = [
      // {
      //   title: "Id",
      //   width: 150,
      //   fixed: "left",
      ...
      // },
      {
        ...
        ...getColumnSearchProps<UpgradeRow>("name", "Tên gói"),
      },
      {
        title: "Giá Tiền",
        width: 100,
        ...
        ...getColumnPriceRangeProps<UpgradeRow>("price", "Giá Tiền"),
        render: (_, record) => (
          <div>
      ...
      },
      {
        ...
        key: "maxPhotoQuota",
        sorter: (a, b) => Number(a.maxPhotoQuota) - Number(b.maxPhotoQuota),
        // ...getColumnSearchProps("maxPhotoQuota", "Dung lượng"),
        render: (descriptions: UpgradeRow["maxPhotoQuota"]) => (
          <div>{Number(descriptions) / 1073741824}GB</div>
        ),
      },
      {
        ...
        key: "maxPackageCount",
        sorter: (a, b) => Number(a.maxPackageCount) - Number(b.maxPackageCount),
        ...getColumnSearchProps<UpgradeRow>("maxPackageCount", "Số lượng"),
      },
      // {
...

      {
        ...
        key: "summary",
        sorter: (a, b) => Number(a.maxPackageCount) - Number(b.maxPackageCount),
        ...getColumnSearchProps<UpgradeRow>("summary", "Tóm tắt"),
      },
      {
        ...
        key: "descriptions",
        width: 300,
        ...getColumnSearchProps<UpgradeRow>("descriptions", "chi tiết"),
        ellipsis: {
          showTitle: false,
        },
        render: (descriptions: UpgradeRow["descriptions"]) => (
          <Tooltip
            placement="topLeft"
    ...
    const reloadData = () => {
      ...
      getData<UpgradeList>("/upgrade-package?limit=9999&page=0")
        .then((e) => {
...
TableUpgrade.displayName = "TableUpgrade";
