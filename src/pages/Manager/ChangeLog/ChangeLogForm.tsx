...
type ChangeLogValues = Yup.InferType<typeof ChangeLogYup>;

type ChangeLogFormProps = {
  selectedChangeLog?: Schema<"ChangeLogDto"> | null;
  onClose?: () => void;
  onSaved?: () => void;
};
...
export default function ChangeLogForm({
  ...
  const methods = useForm<ChangeLogValues>({
  ...
  const onSubmit = (data: ChangeLogValues) => {
    ...
    const body: BodyOf<"ChangeLogController_create"> = { ...data, content };
    const request = selectedChangeLog
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-xl">
            <div className="overflow-y-auto p-4">
              ...
              <div className="mt-10">
                ...
                >
                  {disabled ? "Đang lưu..." : isEdit ? "Cập nhật" : "Tạo mới"}
                </ComButton>
              </div>
            </div>
          </form>
