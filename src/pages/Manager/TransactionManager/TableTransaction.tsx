...
type TableSorter = SorterResult<Transaction> | SorterResult<Transaction>[];
...
export const TableTransaction = forwardRef<unknown, object>((_props, _ref) => {
  ...
  const columns: TableProps<Transaction>["columns"] = [
    ...
    // },
    {
      ...
      ...getColumnSearchProps<Transaction>("user.name", "Người giao dịch"),
      render: (_, record) => (
  ...
  const reloadData = (
    ...
    // console.log("====================================");
    getData<TransactionList>(`/manager/transaction?${search}`)
      .then((e) => {
        setData(e?.data?.objects);
