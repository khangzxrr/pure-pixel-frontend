...
// the report picked in the table ({} before any pick)
export type ReportSelection = Partial<
  Omit<ReportDto, "reportStatus" | "referencedPhoto">
> & {
  // the views also check an "actioned" status the backend does not declare
  reportStatus?: ReportDto["reportStatus"] | "actioned";
  // the photo is shown through its signed url, which PhotoDto does not declare
  referencedPhoto?:
    (Schema<"PhotoDto"> & { signedUrl?: Schema<"SignedUrl"> }) | null;
};
