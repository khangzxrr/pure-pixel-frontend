...
type UploadPhotoSellProps = {
  formRef: RefObject<UploadPhotoSellFormHandle>;
};
...
export default function UploadPhotoSell({ formRef }: UploadPhotoSellProps) {
  const {
    addPhoto,
        ...
        >
          ...
          >
            <Dragger
              ...
              fileList={photoArray as (SellPhotoItem & UploadFile)[]}
              accept=".jpg,.jpeg,.png"
              style={{
                width: "100%",
                padding: "none",
