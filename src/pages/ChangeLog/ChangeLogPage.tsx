...
import type { QueryOf, ResponseOf } from "../../apis/types";
import LoadingSpinner from "../../components/LoadingSpinner/LoadingSpinner";
import UseChangeLogStore from "../../states/UseChangeLogStore";

type FindPublished = "ChangeLogController_findPublished";
...
const ChangeLogPage = () => {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["changelog"],
    queryFn: async () => {
      const query: QueryOf<FindPublished> = { limit: 100, page: 0 };
      return (await getData<ResponseOf<FindPublished>>("/changelog", query))
        .data;
    },
  });
