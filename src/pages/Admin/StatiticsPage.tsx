...
// the page reads the dashboard as a list of daily snapshots, which the generated DashboardReportDto does not describe
const isDashboardHistory = (value: unknown): value is DashboardSnapshot[] =>
  Array.isArray(value);
...
const StatiticsPage = () => {
  ...
  const dataDashboard = isDashboardHistory(data) ? data : [];
