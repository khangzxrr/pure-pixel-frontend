...
import type { BodyOf, ResponseOf, Schema } from "../../apis/types";
import { message } from "antd";

type CreateReport = "UserReportController_createReport";
...
const reportReasons = [
  ...
  { value: "Không đúng sự thật", label: "Không đúng sự thật" },
...
export default function ComReport({
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    //   referenceId: id,
    // });
    const body: BodyOf<CreateReport> = {
      content: reason + " " + details,
      reportType: reportType,
      referenceId: id,
    };
    postData<ResponseOf<CreateReport>>("/user/report", body)
      .then(() => {
        onclose();
