...
type SelectedLocate = Coordinates & { address?: string };
...
export default function UpdateMapModal() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          setIsLoadingCurrentLocation(false);
          // copied from MapBoxModal, whose isOpenMapModal is this modal's isUpdateOpenMapModal
          if (currentLocation || isUpdateOpenMapModal) return;
          notificationApi?.(
            "error",
            "Lỗi",
  ...
  const backToCurrentLocate = () => {
    // without a known location there is nowhere to go back to (this used to throw)
