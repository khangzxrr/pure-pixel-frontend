import type { CurrentUpgradePackage } from "./UpgradePackageCard";

type UpgradeIntroduceProps = {
  // passed by UpgradeToPtgLayout, not used here
  currentPackage?: CurrentUpgradePackage;
};

const UpgradeIntroduce = (_props: UpgradeIntroduceProps) => {
  return (
