...
// createdAt is read here but not declared by PhotoshootPackageReviewDto
export type PackageReview = Schema<"PhotoshootPackageReviewDto"> & {
  createdAt?: string;
};

type BookingPackageReviewCardProps = {
