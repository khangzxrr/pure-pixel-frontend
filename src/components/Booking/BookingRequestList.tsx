...
type SortOrder = Schema<"SortOrder">;
...
// Theme Configuration
// not annotated as ThemeConfig: antd's Select token has no activeBorderColor, which is kept as it was
...
const BookingRequestList = () => {
  ...
  const isSelectedStatus = (value: BookingStatus | "") => status === value;
