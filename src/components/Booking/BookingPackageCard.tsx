...
// the backend sends a prisma `_count` the PhotoshootPackageDto does not declare
export type PhotoshootPackageItem = Schema<"PhotoshootPackageDto"> & {
...
type PhotoshootPackageCardProps = {
  photoshootPackage: PhotoshootPackageItem;
  onClick?: () => void;
};

const PhotoshootPackageCard = ({
  photoshootPackage,
  onClick,
}: PhotoshootPackageCardProps) => {
