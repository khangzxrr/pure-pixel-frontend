...
type BookingPackageShowCaseListProps = {
  photoshootPackage: Pick<Schema<"PhotoshootPackageDto">, "showcases">;
};

const BookingPackageShowCaseList = ({
  photoshootPackage,
}: BookingPackageShowCaseListProps) => {
  return (
