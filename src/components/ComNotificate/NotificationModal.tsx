...
type Notification = Schema<"NotificationDto">;

// payload of the socket "notification-event"
type NotificationEvent = Pick<Notification, "title" | "content"> & {
...
const NotificationModal = ({ isOpen, onClose }: NotificationModalProps) => {
  ...
  const showUpNotification = (data: NotificationEvent) => {
  ...
  useEffect(() => {
    async function showNotification(data: NotificationEvent) {
  ...
  const renderContent = (notification: Notification) => {
    // compared as a string: the "  " case is not a backend reference type
