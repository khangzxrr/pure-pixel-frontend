...
import type { WalletTransactionFilter } from "../../apis/Wallet";

type OrderByCreatedAt = WalletTransactionFilter["orderByCreatedAt"];

type SortDateDropdownProps = {
  orderByCreatedAt: OrderByCreatedAt;
  setOrderByCreatedAt: (orderByCreatedAt: OrderByCreatedAt) => void;
  // Optional: Function for handling dropdown option selection (never used)
