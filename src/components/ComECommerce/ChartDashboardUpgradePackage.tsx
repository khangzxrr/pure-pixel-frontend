...
type ChartDashboardUpgradePackageProps = {
  dashBoardData?: ResponseOf<"AdminController_getDashboardReportData">;
};
...
const ChartDashboardUpgradePackage = ({
  dashBoardData,
}: ChartDashboardUpgradePackageProps) => {
  ...
  useEffect(() => {
    if ((dashBoardData?.topUsedUpgradePackage?.length ?? 0) > 0) {
