...
type ChartDashboardTotalPhotoProps = {
  nameChart?: string;
  param1?: number;
  param2?: number;
  param3?: number;
  ...
  nameParam2?: string;
  nameParam3?: string;
  // accepted but not used by the chart
  isMoney?: boolean;
  isRevenue?: boolean;
};
...
const ChartDashboardTotalPhoto = ({
  ...
  const options: ApexOptions = {
    ...
    // names are optional props; ApexCharts receives them as given
    labels: [nameParam1, nameParam2, nameParam3] as string[],
    legend: {
      show: false,
      position: "bottom",
    },
